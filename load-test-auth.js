...
// Helper function to make tRPC calls - handles queries (GET) and mutations (POST)
function callTRPC(endpoint, input, isQuery = true) {
  const params = {
    headers: {
  ...
  if (isQuery) {
    ...
    // For mutations: pass input in body as JSON
