      ...
      <div className="w-full max-w-md rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-violet-100">
            <School className="h-6 w-6 text-violet-700" />
          </div>
        ...
        <form action={createTenantAction} className="space-y-6">
          ...
          <button
            type="submit"
            className="flex w-full justify-center rounded-xl bg-violet-900 px-4 py-3 text-sm font-semibold text-white shadow-sm hover:bg-violet-800 focus:outline-none focus:ring-2 focus:ring-blue-900 focus:ring-offset-2"
          >
