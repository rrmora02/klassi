...
export function StudentSearchPicker({ students, value, onChange, placeholder = "Buscar alumno...", error }: Props) {
  ...
  if (value) {
    return (
      <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", borderRadius: 8, border: "1px solid var(--color-border-secondary)", background: "#eff6ff" }}>
        <span style={{ fontSize: 14, color: "#1e3a5f", fontWeight: 500, flex: 1 }}>
